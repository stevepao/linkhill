...
$year = (int) date('Y');
?><!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Privacy · <?= $appName ?></title><link rel="stylesheet" href="/assets/css/paos.css"></head>
